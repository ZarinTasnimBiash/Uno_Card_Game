...
public class Game implements GameConstants {
	...
	public Game(int mode){
		...
		//	name=JOptionPane.showInputDialog("PC") ;
			name2 = JOptionPane.showInputDialog("Player 2");
			
		}
		else if (GAMEMODE==Player3) {
			
			name=JOptionPane.showInputDialog("Player 1") ;
			name2 = JOptionPane.showInputDialog("Player 2");
			name3=JOptionPane.showInputDialog("Player 3");
		}
		else {
			name=JOptionPane.showInputDialog("Player 1") ;
			name2 = JOptionPane.showInputDialog("Player 2");
	...
	//	Player player1 = (GAMEMODE==vsPC) ? pc : new Player(name);
		...
		if (GAMEMODE== vsPC) {
			...
			player1.toggleTurn();				//Initially, player2's turn		
		}
	//	players = new Player[]{player1, player2};			
